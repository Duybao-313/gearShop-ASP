...
namespace duybao.data.Migrations
{
    ...
    [Migration("20260623183837_AddBrandSkuRatingReviewToProduct")]
    partial class AddBrandSkuRatingReviewToProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("duybao.data.Entities.Review", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            Comment = "Vest vừa vặn, đường may sắc nét!",
                            CreatedDate = new DateTime(2026, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ProductId = 2,
                            Rating = 5,
                            ReviewerName = "Quang Huy"
                        },
                        new
                        {
                            Id = 4,
                            Comment = "Áo đẹp, vải thoáng mát.",
                            CreatedDate = new DateTime(2026, 6, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ProductId = 3,
                            Rating = 4,
                            ReviewerName = "Thanh Hà"
                        },
                        new
                        {
                            Id = 5,
                            Comment = "Quần tây đẹp, form chuẩn!",
