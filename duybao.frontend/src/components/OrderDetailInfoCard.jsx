...
const OrderDetailInfoCard = ({ icon, title, name, lines, badge }) => {
  return (
    <div className="bg-white border p-4 h-100" style={{ borderColor: "#e2e2e2" }}>
      {/* Header */}
      ...
      {/* Badge */}
      {badge && (
        <span className="d-inline-block text-uppercase mt-2 px-2 py-1"
          style={{
            fontSize: "10px", letterSpacing: "1px", fontWeight: "600",
            backgroundColor: "#f3f3f3", color: "#44474e",
          }}>
          {badge}
        </span>
      )}
